...
namespace DbModel
{
    public class MarketDbManager 
    {
        ...
        public static DbContext ContextFactory(ContextType contextType)
        {
            switch (contextType)
            {
                case ContextType.MicrosoftSQL:
                    return new DbMarketContext();
                case ContextType.MySQL:
                    return new MySQLMarketContext();
                default:
            }
        }
