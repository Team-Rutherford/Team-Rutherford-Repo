...
(
  ID NUMBER(10, 0) NOT NULL 
, SUPERMARKET_NAME NCHAR(200) NOT NULL 
...
DROP TRIGGER SUPERMARKETS_TRG;
CREATE TRIGGER SUPERMARKETS_TRG 
...
, QUANTITY NUMBER(19, 4) NULL 
, CONSTRAINT SALES_PK PRIMARY KEY(ID)
  ENABLE
, CONSTRAINT SALES_PRODUCTS_FK 
  FOREIGN KEY (PRODUCT_ID) REFERENCES PRODUCTS(ID)
  ENABLE
, CONSTRAINT SALES_SUPERMARKETS_FK 
