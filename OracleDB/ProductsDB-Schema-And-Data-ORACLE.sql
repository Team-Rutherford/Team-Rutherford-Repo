...
, SUPERMARKET_ID NUMBER(10, 0) NOT NULL 
...
, CONSTRAINT SALES_PK PRIMARY KEY 
  ...
  USING INDEX 
  (
      CREATE UNIQUE INDEX SALES_PK ON SALES (ID ASC) 
      LOGGING 
      TABLESPACE SYSAUX 
      PCTFREE 10 
      INITRANS 2 
...
ALTER TABLE SALES
ADD CONSTRAINT FK_SALES_PRODUCTS FOREIGN KEY
(
  PRODUCT_ID 
)
REFERENCES PRODUCTS
...
ALTER TABLE SALES
ADD CONSTRAINT FK_SALES_SUPERMARKETS FOREIGN KEY
(
  SUPERMARKET_ID 
)
REFERENCES SUPERMARKETS
(
  ID 
)
ENABLE;
...
(
  ID NUMBER(10, 0) NOT NULL 
, SUPERMARKET_NAME VARCHAR2(100 BYTE) NOT NULL 
, CONSTRAINT SUPERMARKETS_PK PRIMARY KEY 
  (
    ID 
  )
  USING INDEX 
  (
      CREATE UNIQUE INDEX SUPERMARKETS_PK ON SUPERMARKETS (ID ASC) 
      LOGGING 
      TABLESPACE SYSAUX 
      PCTFREE 10 
      INITRANS 2 
